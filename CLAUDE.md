...
- **Cabeçalho (21/09/2026):** faixa de cima com "← Escolas" à esquerda e ☀️/🌙 à direita (Meu Diário, AEE e Perfil). No Meu Diário, o ano do título é um botão (`abrirMenuAno`) que lista os anos da escola e "+ Iniciar" o próximo (`mudarAno`). "Sair" fica só no Perfil (cartão 🚪 Conta); o nome não aparece no cabeçalho. "🔀 Mudar painel" = `ContaSkin.ocupacao.botaoPainel(el, escola, "regente"|"aee")`: some com 1 ocupação; com 2+, lista as ocupações e abre o painel escolhido.
