...
- **Barra do documento:** ✏️ Editar (liga `contenteditable` nas folhas, com aviso), 🖨️ Imprimir / PDF, 🌐 Salvar HTML e 🔗 Compartilhar — imprimir e salvar levam as edições; o HTML salvo sai sem barra e sem modo de edição. **Word e Excel foram removidos** em 25/09/2026 (a pedido do professor: as tabelas saíam quebradas).
