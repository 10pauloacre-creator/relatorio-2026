(function () {
   ...
   */
  if (!document.querySelector('link[data-relatorio-dark-final="20260921b"]')) {
    var currentScript = document.currentScript;
    var themeStylesheet = document.createElement("link");
    themeStylesheet.rel = "stylesheet";
    themeStylesheet.dataset.relatorioDarkFinal = "20260921b";
    themeStylesheet.href = currentScript && currentScript.src
      ? new URL("../css/dark-mode-2026.css?v=20260921b", currentScript.src).href
      : "assets/css/dark-mode-2026.css?v=20260921b";
